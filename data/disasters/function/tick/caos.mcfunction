...
forceload add ~ ~ ~ ~
# Торнадо
execute if entity @s[tag=CN1] as @a if items entity @s container.* minecraft:firework_star[custom_model_data=210101] run title @s actionbar [{"text":"A tornado will spawn at :","bold":true,"color":"yellow"},{"text":" "},{"score":{"name":"@e[tag=CN1,limit=1,sort=nearest]","objective":"Pos0"},"bold":true,"color":"dark_red"},{"text":" ","bold":true,"color":"dark_red"},{"score":{"name":"@e[tag=CN1,limit=1,sort=nearest]","objective":"altura"},"bold":true,"color":"dark_red"},{"text":" ","bold":true,"color":"dark_red"},{"score":{"name":"@e[tag=CN1,limit=1,sort=nearest]","objective":"Pos2"},"bold":true,"color":"dark_red"}]
execute if entity @s[tag=CN1] if score @s Tiempo matches 1200.. run function disasters:tornado/generar

# Землетрясение
execute if entity @s[tag=CN2] as @a if items entity @s container.* minecraft:firework_star[custom_model_data=210101] run title @s actionbar [{"text":"An earthquake will start at :","bold":true,"color":"yellow"},{"text":" "},{"score":{"name":"@e[tag=CN2,limit=1,sort=nearest]","objective":"Pos0"},"bold":true,"color":"dark_red"},{"text":" ","bold":true,"color":"dark_red"},{"score":{"name":"@e[tag=CN2,limit=1,sort=nearest]","objective":"altura"},"bold":true,"color":"dark_red"},{"text":" ","bold":true,"color":"dark_red"},{"score":{"name":"@e[tag=CN2,limit=1,sort=nearest]","objective":"Pos2"},"bold":true,"color":"dark_red"}]
...
# Черная дыра (Gravity)
execute if entity @s[tag=CN5] as @a if items entity @s container.* minecraft:firework_star[custom_model_data=210101] run title @s actionbar [{"text":"Gravity is increasing at :","bold":true,"color":"yellow"},{"text":" "},{"score":{"name":"@e[tag=CN5,limit=1,sort=nearest]","objective":"Pos0"},"bold":true,"color":"dark_red"},{"text":" ","bold":true,"color":"dark_red"},{"score":{"name":"@e[tag=CN5,limit=1,sort=nearest]","objective":"altura"},"bold":true,"color":"dark_red"},{"text":" ","bold":true,"color":"dark_red"},{"score":{"name":"@e[tag=CN5,limit=1,sort=nearest]","objective":"Pos2"},"bold":true,"color":"dark_red"}]
execute if entity @s[tag=CN5] if score @s Tiempo matches 1200.. run function disasters:blackole/generar

# Засуха (Heat)
execute if entity @s[tag=CN6] as @a if items entity @s container.* minecraft:firework_star[custom_model_data=210101] run title @s actionbar [{"text":"Heat is starting to increase","bold":true,"color":"yellow"}]
