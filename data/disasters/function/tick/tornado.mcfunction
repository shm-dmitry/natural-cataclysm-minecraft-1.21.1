...
execute as @e[tag=BloqueTornado1] at @s run tp @s ^ ^0.5 ^0.3 facing entity @e[tag=Tornado,limit=1,sort=random]
...
#seguir
execute as @e at @s store result score @s altura run data get entity @s Pos[1]
execute as @e[tag=seguir] at @s if score @s altura matches 32.. run execute unless entity @a[gamemode=!creative,gamemode=!adventure] run tp @s ^ ^ ^0.15 facing entity @e[type=!player,type=!marker,type=!interaction,type=!item_display,type=!item,limit=1,sort=random,scores={altura=32..}]
execute as @e[tag=seguir] at @s if score @s altura matches 32.. run tp @s ^ ^ ^0.15 facing entity @p[gamemode=!creative,gamemode=!spectator,scores={altura=32..}]
execute as @e[tag=seguir] at @s if score @s altura matches 32.. run execute if entity @a[distance=100..] run tp @s ^ ^ ^4 facing entity @p[gamemode=!creative,gamemode=!spectator,scores={altura=32..}]
...
execute as @e[tag=tornado0] at @s run execute as @a[distance=..3] at @s run tag @s[gamemode=!creative,gamemode=!spectator] add tor1
...
execute as @e[tag=tornado0] at @s run execute as @a[tag=!tor1,distance=3..6] at @s run tp @s[gamemode=!creative,gamemode=!spectator] ^ ^ ^1 facing entity @e[tag=tornado0,limit=1]
execute as @e[tag=tornado0] at @s run execute as @a[scores={tirar=16..}] at @s run tp @s[gamemode=!creative,gamemode=!spectator] ^ ^-1 ^-2 facing entity @e[tag=tornado0,limit=1]
execute as @e[tag=tornado0] at @s run execute as @a[gamemode=!creative,gamemode=!spectator,scores={tirar=0..16}] at @s run tp @s ^ ^0.5 ^ facing entity @e[tag=tornado0,limit=1]
...
execute as @e[tag=!tor1] at @s run scoreboard players reset @s tirar
